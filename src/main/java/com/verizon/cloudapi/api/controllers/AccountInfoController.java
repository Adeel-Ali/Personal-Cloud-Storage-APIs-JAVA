...
public class AccountInfoController extends BaseController {    
    ...
    private static AccountInfoController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the AccountInfoController class 
     */
    public static AccountInfoController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new AccountInfoController();
            }
        }
        return instance;
    }
    ...
    public AccountResponse getAccount(
        ...
        APICallBackCatcher<AccountResponse> callback = new APICallBackCatcher<AccountResponse>();
        getAccountAsync(callback);
    ...
    public void getAccountAsync(
                final APICallBack<AccountResponse> callBack
    ) {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5149759940058870104L;
            {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            AccountResponse _result = APIHelper.deserialize(_responseBody,
